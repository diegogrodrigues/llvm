...
STATISTIC(NumFastIselFailNop,"Fast isel fails on Nop");
#endif
...
void countInstruction(MachineFunction *mf) {
...
bool SelectionDAGISel::runOnMachineFunction(MachineFunction &mf) {
  ...
  for (MachineFunction::const_iterator I = MF->begin(), E = MF->end(); I != E; ++I) {
    ...
    for (MachineBasicBlock::const_iterator II = MBB->begin(), IE = MBB->end();  II != IE; ++II) {
      ...
      //errs()<<"SelectionDAGISel::runOnMachineFunction - count:"<< count++<< "  SelectionDAG - Opcode: "<< II->getOpcode() << "\n";
...
static void collectFailStats(const Instruction *I) {
  ...
  case Instruction::Nop:     		 NumFastIselFailNop++; return;

...
private:
  ...
  bool X86SelectNop(const Instruction *I);
...
bool X86FastISel::X86FastEmitStore(EVT VT, unsigned ValReg, const X86AddressMode &AM, bool Aligned) {
...
/// X86SelectStore - Select and emit code to implement store instructions.
bool X86FastISel::X86SelectNop(const Instruction *I) {


  BuildMI(*FuncInfo.MBB, FuncInfo.InsertPt,  DL, TII.get(X86::NOOP));

  ...
  do {
    ...
    switch (ParseInstruction(Inst, BB, PFS)) {
		...
		case InstNormal:
		  ...
		  //errs() << "ParseBasicBlock - InstNormal:" << Inst->getOpcode() <<"\n";
		  //errs() << " name:" << Inst->getOpcodeName() <<"\n";
		...
		case InstExtraComma:
		  ...
		  //errs() << "ParseBasicBlock - InstExtraComma:" << Inst->getOpcode() <<"\n";
...
int LLParser::ParseInstruction(Instruction *&Inst, BasicBlock *BB,
  ...
  case lltok::kw_nop:     		  Inst = new NopInst(Context); return false;// return ParseNop(Inst, PFS);
